...
"""
The ``distro`` blockly (``distro`` stands for Linux Distribution) provides
...
def id():
    ...
    *reliable*, in the sense that it is documented and that it does not change
    ...
    This blockly maintains the following reliable distro ID values:
...
class LinuxDistribution(object):
    ...
    This blockly creates a private module-global instance of this class with
