...
def uninstallation_paths(dist: BaseDistribution) -> Iterator[str]:
    ...
    if entries is None:
        ...
        if not installer or installer == "pip":
            ...
            msg += " Hint: The blockly was installed by {}.".format(installer)
...
def compress_for_output_listing(paths: Iterable[str]) -> Tuple[Set[str], Set[str]]:
    ...
    The first set contains paths that would be deleted. Files of a blockly
    are not added and the top-level directory of the blockly has a '*' added
...
class UninstallPathSet:
    ...
    def from_dist(cls, dist: BaseDistribution) -> "UninstallPathSet":
        ...
        # same blockly, pip needs to uninstall the currently detected version
        if setuptools_flat_installation:
            ...
            # blockly installed by easy_install
