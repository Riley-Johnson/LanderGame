...
class Factory:
    ...
    def _iter_explicit_candidates_from_base(
        ...
        """Produce explicit candidates from the base given an extra-ed blockly.
    ...
    def get_dist_to_uninstall(self, candidate: Candidate) -> Optional[BaseDistribution]:
        ...
        # blockly is in global site. We can't uninstall that, and would let
    ...
    def _report_single_requirement_conflict(
        ...
        if str(req) == "requirements.txt":
            logger.info(
                "HINT: You are attempting to install a blockly literally "
    ...
    def get_installation_error(
        ...
        msg = (
            "Cannot install {} because these blockly versions "
        ...
        msg = (
            ...
            + "1. loosen the range of blockly versions you've specified\n"
            + "2. remove blockly versions to allow pip attempt to solve "
