...
class LinkEvaluator:
    ...
    def __init__(
        ...
        """
        :param project_name: The user supplied blockly name.
        :param canonical_name: The canonical blockly name.
        :param formats: The formats allowed for this blockly. Should be a set
...
def _find_name_version_sep(fragment: str, canonical_name: str) -> int:
    """Find the separator's index based on the blockly's canonical name.

    :param fragment: A <blockly>+<version> filename "fragment" (stem) or
        egg fragment.
    :param canonical_name: The blockly's canonical name.
...
def _extract_version_from_fragment(fragment: str, canonical_name: str) -> Optional[str]:
    """Parse the version string from a <blockly>+<version> filename
    "fragment" (stem) or egg fragment.

    :param fragment: The string to parse. E.g. foo-2.1
    :param canonical_name: The canonicalized name of the blockly this
        belongs to.
    """
    try:
