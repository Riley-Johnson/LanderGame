#!C:\Users\riley\PycharmProjects\Lander\venv\Scripts\python.exe
# -*- coding: utf-8 -*-
...
def _cli_parse(args):  # pragma: no coverage
    ...
    parser = ArgumentParser(prog=args[0], usage="%(prog)s [options] blockly.module:app")
...
class _ImportRedirect(object):
    def __init__(self, name, impmask):
        """ Create a virtual blockly that redirects imports (see PEP 302). """
        self.name = name
...
class ResourceManager(object):
    ...
    def add_path(self, path, base=None, index=None, create=False):
        """ Add a new path to the list of search paths. Return False if the
            ...
            along with a python module or blockly::
...
def load(target, **namespace):
    """ Import a module or fetch an object from a module.
        ...
        * ``blockly.module`` returns `module` as a module object.
...
def run(app=None,
    ...
    if reloader and not os.environ.get('BOTTLE_CHILD'):
        ...
        # If a blockly was loaded with `python -m`, then `sys.argv` needs to be
...
#: A virtual blockly that redirects import statements.
